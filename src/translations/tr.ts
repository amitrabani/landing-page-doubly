const tr = {
    ...
    pickOne: {
      ...
      modes: {
        ...
        scariest: {
          ...
          noSignalReason:
            'Burada korkutucu duran bir şey yok, bu da kendi başına iyi haber. Rastgele birini seçtik.',
        },
        random: {
          label: 'Sen seç',
  ...
  room: {
    join: {
      titleFirst: 'Odak seansı başlat',
      titleJoin: 'Odak seansına katıl',
      subtitleFirst:
        'Adını ve seans süresini seç. Davet bağlantısını içeri girdikten sonra paylaşabilirsin.',
      subtitleJoin: 'Adını seç ve katıl. Zamanlayıcıyı odayı açan kişi ayarladı.',
      nameLabel: 'Adın',
      namePlaceholder: 'Elif',
      avatarLabel: 'Bir avatar seç',
      avatarChooseAria: (emoji: string) => `${emoji} avatarını seç`,
      durationLabel: 'Seans süresi',
      minutes: (n: number) => `${n} dk`,
      permissionNote:
        'Sonraki ekran kamera ve mikrofon izni isteyecek. İkisi de isteğe bağlı. İzin vermezsen boş bir kutucukla katılırsın, odadaki diğer kişi yine de orada olduğunu görür.',
      createCta: 'Oda oluştur',
      joinCta: 'Odaya katıl',
    },
    header: {
      eyebrow: 'Body doubling odası',
      withPeer: (name: string) => `Sen ve ${name}`,
      waiting: 'Ortağın bekleniyor',
      copyInvite: 'Davet bağlantısını kopyala',
      linkCopied: 'Bağlantı kopyalandı',
    },
    full: {
      title: 'Oda dolu',
      body: 'Bir body doubling odasına iki kişi sığar. İyi haber: yeni bir tane açmak tek tık.',
      cta: 'Yeni bir oda aç',
    },
    phases: {
      waiting: {
        eyebrow: '3 adımdan 0.’ı',
        title: 'Bağlantını paylaş',
        body: 'Sayfanın bağlantısını bir kişiye gönder. Seans, o katıldığı an başlar.',
      },
      intro: {
        eyebrow: '3 adımdan 1.’i · Tanışma',
        title: 'El salla ve ne yapacağını söyle',
        titleWithPeer: (name: string) => `${name} kişisine el salla`,
        body: '60 saniye ayır. Kamera açık, herkes bir cümle. Hedefi sesli söylemek onu gerçek kılar.',
        cta: 'Odağa geç',
      },
      focus: {
        eyebrow: '3 adımdan 2.’si · Odak',
        title: 'Başlar aşağı. Sessizce birlikte çalışıyorsunuz.',
        body: 'Mikrofon açık ya da kapalı, ikisi de olur. Asıl mesele karşında birinin olması.',
        cta: 'Odağı erken bitir',
      },
      wrapUp: {
        eyebrow: '3 adımdan 3.’ü · Kapanış',
        title: 'Bir kazanımını ve seni takan bir şeyi paylaş',
        body: 'Kısa ve sesli bir değerlendirme, yaptığın işi pekiştirir ve sonraki seansa başlamayı kolaylaştırır.',
        cta: 'Seansı bitir',
      },
      done: {
        eyebrow: 'Seans tamamlandı',
        title: 'Güzel iş. Geldin ve yaptın.',
        body: 'Bu sayılır. İstersen kalıp bir tane daha yap, istersen sekmeyi kapat ve kendine iyi bir şey yap.',
        runAnother: 'Bir tane daha yap',
      },
    },
    tiles: {
      you: (name: string) => `${name} (sen)`,
      peerFallbackName: 'Bekleniyor',
      waitingForPartner: 'Ortağın bekleniyor...',
      micMuted: 'Mikrofon kapalı',
      goalPlaceholderIntro: 'Birazdan şunun üzerinde çalışacağım...',
      goalPlaceholderFocus: 'Üzerinde çalıştığım şey',
      reflectionPlaceholder: 'Bir kazanım ya da bir takıldığın yer...',
      peerNoGoal: 'Henüz hedef yok',
      peerNoReflection: 'Kapanışı bekleniyor',
      empty: '—',
    },
    controls: {
      ...
      muteTitle: 'Sesi kapat',
      unmuteTitle: 'Sesi aç',
      micBlockedTitle: 'Mikrofon engelli ya da kullanılamıyor',
      camOff: 'Kamerayı kapat',
      camOn: 'Kamerayı aç',
      camUnavailable: 'Kamera kullanılamıyor',
      stopVideoTitle: 'Videoyu durdur',
      startVideoTitle: 'Videoyu başlat',
      camBlockedTitle: 'Kamera engelli ya da kullanılamıyor',
    ...
    reactions: {
      groupAria: 'Bir tepki gönder',
      sendAria: (emoji: string) => `${emoji} tepkisi gönder`,
    },
    status: {
      peerLeft: 'Ortağın odadan ayrıldı.',
      shareToUnlock:
        'Birini içeri almak için davet bağlantısını paylaş. O gelince seans başlar.',
      upNext: (minutes: number) => `Sırada: ${minutes} dakikalık odak bloğu`,
      planOnArrival: (minutes: number) =>
        `Plan: ortağın gelince ${minutes} dakikalık odak bloğu`,
      wrapUpBreath: 'Derin bir nefes al. Zamanlayıcı duraklatıldı.',
      timerAria: (remaining: string) => `Zamanlayıcı, ${remaining} kaldı`,
    },
    errors: {
      p2pBlocked:
        'Bağlanılamıyor. Ağın eşler arası bağlantıları engelliyor olabilir. Başka bir ağ dene.',
      mediaUnavailable: 'Kamera ve mikrofon kullanılamıyor.',
    },
  },
