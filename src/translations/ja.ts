const ja = {
    ...
    pickOne: {
      ...
      modes: {
        ...
        scariest: {
          ...
          noSignalReason:
            'こわそうなものは見当たりません。それはそれで良いニュース。ランダムに1つ選びました。',
        },
        random: {
          label: 'とにかく1つ',
      ...
      // Dread words for the "Scariest" mode, localized (not translated): the
      // obligations and conversations Japanese speakers actually avoid, written
      // as the stems that appear inside real sentences (歯医者 catches
      // 「歯医者を予約」, 返信 catches 「母に返信」). Bare 税 / 金 are avoided on
      // purpose: 金 would also match 金曜日.
      scaryWords: [
        '確定申告',
        '年末調整',
        '税金',
  ...
  // The live body-doubling room at /r/[id]. Rendered per viewer, so the two
  // people may be reading two different languages: never build a sentence out
  // of the other person's UI strings.
  room: {
    join: {
      titleFirst: '集中セッションを始める',
      titleJoin: '集中セッションに参加する',
      subtitleFirst: '名前とセッションの長さを選んでください。招待リンクは入ってから共有できます。',
      subtitleJoin: '名前を選んで参加するだけ。タイマーはホストが設定済みです。',
      nameLabel: 'あなたの名前',
      namePlaceholder: 'ゆうき',
      avatarLabel: 'アバターを選ぶ',
      avatarChooseAria: (emoji: string) => `${emoji}のアバターを選ぶ`,
      durationLabel: 'セッションの長さ',
      minutes: (n: number) => `${n}分`,
      permissionNote:
        '次の画面でカメラとマイクの許可を聞かれます。どちらも任意です。スキップしてもゴーストタイルで参加でき、相手にはあなたがいることが伝わります。',
      createCta: 'ルームを作る',
      joinCta: 'ルームに入る',
    },
    header: {
      eyebrow: 'ボディダブリング・ルーム',
      withPeer: (name: string) => `あなたと${name}`,
      waiting: '相手を待っています',
    ...
    full: {
      title: 'ルームは満員です',
      body: 'ボディダブリングのルームは2人まで。でも、新しいルームは1クリックで作れます。',
      cta: '新しいルームを作る',
    },
    phases: {
      waiting: {
        eyebrow: 'ステップ 0 / 3',
        title: 'リンクを共有',
        body: 'このページのURLを誰か1人に送ってください。相手が入った瞬間に始まります。',
      },
      intro: {
        eyebrow: 'ステップ 1 / 3 · イントロ',
        title: '手をふって、これからやることを言う',
        titleWithPeer: (name: string) => `${name}に手をふる`,
        body: '60秒だけ。カメラをオンにして、ひとことずつ。声に出すと、ちゃんと残ります。',
        cta: '集中を始める',
      },
      focus: {
        eyebrow: 'ステップ 2 / 3 · 集中',
        title: '黙々と。ふたりで一緒に作業中です。',
        body: 'マイクはオンでもオフでもOK。相手がそこにいることが大事。',
        cta: '集中を早めに終える',
      },
      wrapUp: {
        eyebrow: 'ステップ 3 / 3 · ふりかえり',
        title: 'できたこと1つと、つまずいたこと1つを話す',
        body: '短く声に出すだけで、やったことが定着して、次も始めやすくなります。',
        cta: 'セッションを終える',
      },
      done: {
        eyebrow: 'セッション完了',
        title: 'おつかれさま。ちゃんと来ましたね。',
        body: 'それが何より。もう1回やってもいいし、タブを閉じて自分をいたわってもいい。',
        runAnother: 'もう1回やる',
      },
    },
    tiles: {
      you: (name: string) => `${name}（あなた）`,
      peerFallbackName: '待機中',
      waitingForPartner: '相手を待っています...',
      micMuted: 'マイクはミュート中',
      goalPlaceholderIntro: 'これからやること...',
      goalPlaceholderFocus: '今やっていること',
      reflectionPlaceholder: 'できたこと、またはつまずき...',
      peerNoGoal: 'まだ目標なし',
      peerNoReflection: 'ふりかえり待ち',
      empty: '—',
    },
    controls: {
      muteMic: 'マイクをミュート',
      unmuteMic: 'ミュートを解除',
      micUnavailable: 'マイクが使えません',
      muteTitle: 'ミュート',
      unmuteTitle: 'ミュート解除',
      micBlockedTitle: 'マイクがブロックされているか使えません',
      camOff: 'カメラをオフ',
      camOn: 'カメラをオン',
      camUnavailable: 'カメラが使えません',
      stopVideoTitle: 'ビデオを停止',
      startVideoTitle: 'ビデオを開始',
      camBlockedTitle: 'カメラがブロックされているか使えません',
      startTimer: 'タイマー開始',
      pauseTimer: 'タイマー一時停止',
      leave: '退出',
      retry: '再試行',
    ...
    reactions: {
      groupAria: 'リアクションを送る',
      sendAria: (emoji: string) => `${emoji}のリアクションを送る`,
    },
    status: {
      peerLeft: '相手がルームを出ました。',
      shareToUnlock: '招待リンクを共有して、誰か1人を呼びましょう。相手が来たら始まります。',
      upNext: (minutes: number) => `次は${minutes}分の集中ブロック`,
      planOnArrival: (minutes: number) => `予定：相手が来たら${minutes}分の集中ブロック`,
      wrapUpBreath: 'ひと息ついて。タイマーは止まっています。',
      timerAria: (remaining: string) => `タイマー、残り${remaining}`,
    },
    errors: {
      p2pBlocked:
        '接続できません。ネットワークがP2P接続をブロックしているかもしれません。別のネットワークを試してください。',
      mediaUnavailable: 'カメラとマイクが使えません。',
    },
  },
