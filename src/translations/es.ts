const es = {
  ...
  village: {
    ...
    rewards: {
      ...
      strength: 'Aparato nuevo en el gimnasio',
      running: 'La pista creció',
      reading: '+1 libro en la biblioteca',
      water: 'Subió el nivel del pozo',
    },
    tilesTitle: 'Lo que construiste',
    tiles: {
      homes: 'Casas',
      trees: 'Árboles',
      veggies: 'Huerto',
