const fr = {
  ...
  hero: {
    ...
    phone: {
      screenAlt: 'L’app Doubly montrant chaque habitude comme une île, avec le nombre de fois où tu l’as faite',
    },
  },
  ...
  village: {
    ...
    rewards: {
      ...
      strength: 'Du nouveau matériel à la salle',
      running: 'La piste s’est allongée',
      reading: '+1 livre à la bibliothèque',
      water: 'Le puits a grandi',
    },
    tilesTitle: 'Ce que tu as construit',
    tiles: {
      homes: 'Maisons',
      trees: 'Arbres',
      veggies: 'Potager',
      strength: 'Salle de sport',
      running: 'Piste',
      water: 'Puits',
      reading: 'Bibliothèque',
      rest: 'Lampes',
      other: 'Fleurs',
