const hi = {
  ...
  hero: {
    ...
    phone: {
      screenAlt: 'Doubly ऐप जो हर आदत को उसके अपने द्वीप के रूप में दिखाता है, साथ में आपने उसे कितनी बार किया',
    },
  },
  ...
  // CookieBanner
  cookieBanner: {
    message: 'हम विज़िट और अपने विज्ञापनों के प्रदर्शन को मापने के लिए कुकीज़ का इस्तेमाल करते हैं।',
  ...
  toolCards: {
    ...
    'brain-dump': {
      title: 'ब्रेन डंप टूल',
      description:
        'जो भी दिमाग़ में है सब बाहर निकालें, AI उसमें से सिर्फ़ करने लायक काम छाँट लेता है। न साइन-अप।',
    },
    'pick-one': {
