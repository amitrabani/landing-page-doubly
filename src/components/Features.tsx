...
const featureColors = [
  'bg-lavender-light/25 text-lavender-dark',
  'bg-coral-light/25 text-coral-dark',
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {t.features.items.map((f, i) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl ${featureColors[i]} mb-5 group-hover:scale-110 transition-transform`}>
                {featureIcons[i]}
              </div>
