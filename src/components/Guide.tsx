          ...
          >
            <div className="relative w-full max-w-sm">
              ...
              <div className="relative z-30 bg-white rounded-2xl shadow-xl shadow-charcoal/8 border border-charcoal/5 p-5">
                <div className="text-xs font-medium text-lavender-dark mb-3">{t.guide.mockup.brainDump}</div>
                <div className="space-y-2">
                  {t.guide.mockup.items.map(
                    (item) => (
                      <div
                        key={item}
              ...
              <div className="absolute top-8 -right-4 z-20 bg-white rounded-2xl shadow-lg shadow-charcoal/5 border border-charcoal/5 p-5 w-52">
                <div className="text-xs font-medium text-coral-dark mb-2">{t.guide.mockup.yourNextStep}</div>
                <div className="bg-coral-light/20 rounded-xl px-3 py-3 text-sm font-medium text-charcoal">
                  {t.guide.mockup.nextStepTask}
                </div>
                <div className="mt-2 text-xs text-muted-light">{t.guide.mockup.nextStepMeta}</div>
              </div>
              ...
              <div className="absolute -bottom-6 right-2 z-10 bg-white rounded-2xl shadow-lg shadow-charcoal/5 border border-charcoal/5 p-4 w-48">
                <div className="text-xs font-medium text-sky mb-2">{t.guide.mockup.accountability}</div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-sky-light" />
                  <span className="text-xs text-charcoal-light">{t.guide.mockup.accountabilityText}</span>
                </div>
              </div>
            </div>
          </motion.div>
