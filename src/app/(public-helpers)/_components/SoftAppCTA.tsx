      ...
      <div className="flex flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-col items-start gap-3 sm:items-end">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-charcoal text-cream px-6 py-3 font-semibold hover:bg-charcoal-light transition-colors"
          >
          ...
          <p className="text-xs text-muted-light">Free to start. No credit card required.</p>
        </div>
      </div>
    </section>
  );
