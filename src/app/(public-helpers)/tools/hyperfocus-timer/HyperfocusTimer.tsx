    ...
    >
      {isIdle && (
        <div className="flex flex-col gap-6">
          ...
          <div>
            <p className="text-sm font-medium text-charcoal mb-2">Check in every</p>
            ...
            {customIntervalOpen && (
              <div
                ...
                className="mt-3 flex flex-wrap items-end gap-3 rounded-2xl bg-white/40 backdrop-blur-sm p-4 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.5)]"
              >
          ...
          <div className="grid sm:grid-cols-2 gap-3 border-t border-warm-dark/20 pt-6">
            <label className="inline-flex items-center gap-2 cursor-pointer text-sm text-charcoal-light">
              <input
                type="checkbox"
              ...
              />
              Chime at each check-in (gets louder if ignored)
            </label>
            <label className="inline-flex items-center gap-2 cursor-pointer text-sm text-charcoal-light">
              <input
                type="checkbox"
                checked={settings.announceTime}
                onChange={(e) => setSettings((s) => ({ ...s, announceTime: e.target.checked }))}
                className="h-4 w-4 rounded accent-lavender-dark"
              />
              Announce the time out loud
            </label>
            <label className="inline-flex items-start gap-2 cursor-pointer text-sm text-charcoal-light sm:col-span-2">
              <input
                type="checkbox"
                checked={settings.notificationsEnabled && notificationState !== 'denied'}
                ...
                className="mt-0.5 h-4 w-4 rounded accent-lavender-dark"
              />
              <span>
